...
contract RespectMandala {
    ...
    event RuleDeclared(uint256 indexed id, RespectRule ruleType);
    ...
    function _declare(RespectRule ruleType, string memory description) internal {
        mandalaCount++;
