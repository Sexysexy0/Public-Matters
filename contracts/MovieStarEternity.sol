...
/// @title MovieStarEternity
/// @notice Covenant contract encoding eternity-level guardianship of Hollywood’s cultural safeguards
contract MovieStarEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to MovieStarCodex entry
