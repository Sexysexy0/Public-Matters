...
contract SustainabilityResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Continuous Reforestation Program"
        string resonance;  // e.g. "Align governance with ecological balance"
        bool active;
    }
