...
/// @title Responsibility Mandala
/// @notice Weaves responsibility into mandala resonance.
/// @dev Complements IntegrityTreaty, DutyMandala, and AccountabilityTreaty.

contract ResponsibilityMandala {
    address public guardian;
    uint256 public mandalaCount;
    uint256 public violationCount;
    uint256 public councilCount;

    enum ResponsibilityRule {
        ResponsibilityIsConstitutional,
        DutyAnchored,
        IrresponsibilityProhibited,
        NeglectBlocked,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        TransparencyInResponsibilitySystems
    }
    ...
    event RuleDeclared(uint256 indexed id, ResponsibilityRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(ResponsibilityRule.ResponsibilityIsConstitutional, "Responsibility is constitutional; denial prohibited.");
        _declare(ResponsibilityRule.DutyAnchored, "Duty anchored; failure prohibited.");
        _declare(ResponsibilityRule.IrresponsibilityProhibited, "Irresponsibility prohibited; violation blocked.");
        _declare(ResponsibilityRule.NeglectBlocked, "Neglect blocked; breach prohibited.");
        _declare(ResponsibilityRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(ResponsibilityRule.MandatoryCouncilOversight, "Council oversight required for responsibility enforcement.");
        _declare(ResponsibilityRule.TransparencyInResponsibilitySystems, "Responsibility systems must be transparent.");
    }

    function _declare(ResponsibilityRule ruleType, string memory description) internal {
        mandalaCount++;
