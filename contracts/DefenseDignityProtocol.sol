// contracts/DefenseDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title DefenseDignityProtocol
 * @notice Ensures validator-grade dignity in defense systems and alliances.
 */
contract DefenseDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "CivilianProtection", "Transparency", "ResponsibleDeterrence"
        string description;
