...
/// @title Peace Treaty
/// @notice Unifies peace commitments into treaty law.
/// @dev Complements SolidarityMandala, HumanityCharter, and CommunalHarmonyTreaty.

contract PeaceTreaty {
    ...
    enum PeaceRule {
        PeaceIsConstitutional,
        NonViolenceAnchored,
        ReconciliationProtected,
        StabilitySafeguarded,
    ...
    function _declareDefaultRules() internal {
        _declare(PeaceRule.PeaceIsConstitutional, "Peace is constitutional; denial prohibited.");
        _declare(PeaceRule.NonViolenceAnchored, "Non-violence is anchored; suppression prohibited.");
        _declare(PeaceRule.ReconciliationProtected, "Reconciliation is protected; blocking prohibited.");
        _declare(PeaceRule.StabilitySafeguarded, "Stability safeguarded; erasure prohibited.");
        _declare(PeaceRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(PeaceRule.MandatoryCouncilOversight, "Council oversight required for peace enforcement.");
        _declare(PeaceRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }
