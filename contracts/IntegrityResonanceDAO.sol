...
contract IntegrityResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Privacy Protection Program"
        string resonance;  // e.g. "Align digital governance with human values and integrity"
        bool active;
    }
