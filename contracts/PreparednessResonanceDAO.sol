// PreparednessResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract PreparednessResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Community Disaster Preparedness Program"
        string resonance;  // e.g. "Align disaster response with resilience and readiness"
        bool active;
    }
