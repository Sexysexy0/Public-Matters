...
/// @title Dignity Charter
/// @notice Firewall for human dignity and systemic protections.
/// @dev Complements WellbeingFramework, HopeFramework, and ResilienceCharter.
...
contract DignityCharter {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(DignityRule.HumanRightsProtected, "Human rights are protected; suppression prohibited.");
        _declare(DignityRule.EqualityAnchored, "Equality is anchored; erasure prohibited.");
        _declare(DignityRule.ResilienceSafeguarded, "Resilience safeguarded; bottom rock joy valid.");
