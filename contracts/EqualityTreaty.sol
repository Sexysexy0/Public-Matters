...
/// @title Equality Treaty
/// @notice Unifies equality commitments into treaty law.
/// @dev Complements ResilienceMandala, PeaceTreaty, and HumanityCharter.
...
contract EqualityTreaty {
    ...
    enum EqualityRule {
        EqualityIsConstitutional,
        NonDiscriminationAnchored,
        EqualOpportunityProtected,
        DignitySafeguarded,
    ...
    event RuleDeclared(uint256 indexed id, EqualityRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(EqualityRule.EqualityIsConstitutional, "Equality is constitutional; denial prohibited.");
        _declare(EqualityRule.NonDiscriminationAnchored, "Non-discrimination is anchored; suppression prohibited.");
        _declare(EqualityRule.EqualOpportunityProtected, "Equal opportunity protected; blocking prohibited.");
        _declare(EqualityRule.DignitySafeguarded, "Dignity safeguarded; erasure prohibited.");
        _declare(EqualityRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(EqualityRule.MandatoryCouncilOversight, "Council oversight required for equality enforcement.");
        _declare(EqualityRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }

    function _declare(EqualityRule ruleType, string memory description) internal {
        treatyCount++;
