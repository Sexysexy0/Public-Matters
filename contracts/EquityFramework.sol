...
/// @notice Encodes equity as systemic safeguard.
/// @dev Complements AccountabilityFramework, CitizensDividendMandala, and TransparencyTreaty.

contract EquityFramework {
    ...
    enum EquityRule {
        ...
        FairDistributionAnchored,
        OpportunityAccessProtected,
        BiasSuppressionSafeguarded,
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(EquityRule.FairDistributionAnchored, "Fair distribution anchored; unfairness prohibited.");
        _declare(EquityRule.OpportunityAccessProtected, "Opportunity access protected; blocking prohibited.");
        _declare(EquityRule.BiasSuppressionSafeguarded, "Bias suppression safeguarded; enforcement prohibited.");
