// contracts/FoodDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title FoodDignityProtocol
 * @notice Ensures validator-grade dignity in food security systems.
 */
contract FoodDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "EqualAccess", "NoWaste", "Transparency"
        string description;
