...
/// @title Trust Treaty
/// @notice Unifies trust commitments into treaty law.
/// @dev Complements FairnessMandala, IntegrityCharter, and AccountabilityFramework.
...
contract TrustTreaty {
    ...
    function _declareDefaultRules() internal {
        _declare(TrustRule.TrustIsConstitutional, "Trust is constitutional; denial prohibited.");
        _declare(TrustRule.CommitmentAnchored, "Commitment anchored; failure prohibited.");
        _declare(TrustRule.ConfidenceProtected, "Confidence protected; breach prohibited.");
        _declare(TrustRule.BetrayalBlocked, "Betrayal blocked; violation prohibited.");
        _declare(TrustRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(TrustRule.MandatoryCouncilOversight, "Council oversight required for trust enforcement.");
        _declare(TrustRule.TransparencyInTrustSystems, "Trust systems must be transparent.");
    }

    function _declare(TrustRule ruleType, string memory description) internal {
        treatyCount++;
