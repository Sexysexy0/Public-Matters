...
/// @title FastWeightsPlanetaryTransparency
/// @notice Covenant contract to make DAO proposals and planetary fast weights outcomes publicly accessible
contract FastWeightsPlanetaryTransparency {
    address public owner;

    struct Outcome {
        uint256 proposalId;   // linked to FastWeightsDAO proposal
