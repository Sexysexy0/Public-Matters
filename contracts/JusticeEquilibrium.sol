...
/// @title Justice Equilibrium Covenant
/// @notice Encodes equilibrium of justice and fairness.
/// @dev Complements HumanSolidarityTreaty, EquityMandala, and DignityCharter.

contract JusticeEquilibrium {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(JusticeRule.EqualityProtected, "Equality is protected; erasure prohibited.");
        _declare(JusticeRule.BalanceSafeguarded, "Balance safeguarded; systemic harmony required.");
    ...
    function _declare(JusticeRule ruleType, string memory description) internal {
        ...
        emit RuleDeclared(equilibriumCount, ruleType);
    }
