// contracts/EconomicDignityProtocol.sol
pragma solidity ^0.8.20;

/**
 * @title EconomicDignityProtocol
 * @notice Ensures validator-grade dignity in economic defense and communal audit.
 */
contract EconomicDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "FairAccess", "Transparency", "Resilience"
        string description;
