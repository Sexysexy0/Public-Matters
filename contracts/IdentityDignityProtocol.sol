// contracts/IdentityDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title IdentityDignityProtocol
 * @notice Ensures validator-grade dignity in digital identity systems.
 */
contract IdentityDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "EqualAccess", "NoDiscrimination", "Transparency"
        string description;
