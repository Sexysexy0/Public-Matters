...
/// @notice Encodes balance as systemic safeguard.
/// @dev Complements KindnessTreaty, UnityCharter, and JusticeEquilibrium.

contract BalanceFramework {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(BalanceRule.FairnessAnchored, "Fairness is anchored; suppression prohibited.");
        _declare(BalanceRule.StabilityProtected, "Stability is protected; blocking prohibited.");
        _declare(BalanceRule.HarmonySafeguarded, "Harmony safeguarded; erasure prohibited.");
