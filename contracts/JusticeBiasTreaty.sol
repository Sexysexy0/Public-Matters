...
/// @title JusticeBiasTreaty
/// @notice Covenant contract to unify bias shields into binding treaty-level governance
contract JusticeBiasTreaty {
    address public owner;

    struct TreatyClause {
        uint256 safeguardId;  // linked to JusticeBiasShield entry
