// contracts/SafeSpaceProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title SafeSpaceProtocol
 * @notice Ensures validator-grade safe housing and communal dignity.
 */
contract SafeSpaceProtocol {
    address public admin;

    struct Rule {
        string name;        // "FireSafety", "FloodResilience"
        string description;
