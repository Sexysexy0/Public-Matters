...
contract TrustResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Transparent Data Handling Program"
        string resonance;  // e.g. "Align digital governance with user trust"
        bool active;
    }
