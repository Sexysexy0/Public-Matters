...
/// @title DigitalIntegrationTreaty
/// @notice Encodes MAS and IRTS integration rules.
/// @dev Anchors workflow automation, request tracking, and system migration.

contract DigitalIntegrationTreaty {
    address public overseer;
    uint256 public treatyCount;

    struct IntegrationRule {
        uint256 id;
        string principle;   // MAS, IRTS, Automation
        string description;
        uint256 timestamp;
    }
