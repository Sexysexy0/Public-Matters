...
/// @title InnovationOmega
/// @notice Covenant contract encoding omega-level finality of innovation safeguards
contract InnovationOmega {
    address public owner;

    struct Omega {
        uint256 eternityId; // linked to InnovationEternity entry
