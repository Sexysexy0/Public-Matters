...
/// @title GenderIdeologyEternity
/// @notice Covenant contract encoding eternity-level guardianship of cultural safeguards
contract GenderIdeologyEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to GenderIdeologyCodex entry
        string domain;     // e.g. "Child Safeguards", "Free Speech", "Mob Psychology", "Institutional Resilience"
