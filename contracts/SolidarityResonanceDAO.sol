...
contract SolidarityResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Digital Labor Solidarity Program"
        string resonance;  // e.g. "Align platforms with worker dignity and fairness"
        bool active;
    }
