...
/// @title CommunityCrashEternity
/// @notice Covenant contract encoding eternity-level guardianship of gamer sentiment and industry reset
contract CommunityCrashEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to CommunityCrashCodex entry
        string domain;     // e.g. "Sentiment Safeguards", "Indie Guardianship", "Anti-Monetisation", "Cultural Fatigue"
