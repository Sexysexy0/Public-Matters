...
/// @title GameLayersEternity
/// @notice Covenant contract encoding eternity-level guardianship of Micro–Mezo–Macro gameplay balance
contract GameLayersEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to GameLayersCodex entry
