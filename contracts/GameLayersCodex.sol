...
/// @title GameLayersCodex
/// @notice Covenant contract encoding safeguards for Micro–Mezo–Macro gameplay integrity
contract GameLayersCodex {
    address public owner;

    struct Safeguard {
        uint256 arcId;     // linked to game layer arc
        string domain;     // e.g. "Micro Execution", "Mezo Probability", "Macro Strategy", "Hybrid Gameplay", "Self-Discovery"
    ...
    /// @notice Encode game layer arc into covenant safeguard
