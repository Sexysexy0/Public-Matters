...
/// @notice Encodes autonomy safeguards.
/// @dev Complements DignityTreaty, VisionCharter, and ResponsibilityMandala.

contract AutonomyFramework {
    ...
    enum AutonomyRule {
        AutonomyIsConstitutional,
        AgencyAnchored,
        PawnhoodProhibited,
        ManipulationBlocked,
        IndependenceRequired,
        PublicBenefitPriority,
        TransparencyInAutonomySystems
    }
    ...
    event RuleDeclared(uint256 indexed id, AutonomyRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(AutonomyRule.AutonomyIsConstitutional, "Autonomy is constitutional; denial prohibited.");
        _declare(AutonomyRule.AgencyAnchored, "Agency anchored; abdication prohibited.");
        _declare(AutonomyRule.PawnhoodProhibited, "Pawnhood prohibited; manipulation blocked.");
        _declare(AutonomyRule.ManipulationBlocked, "Manipulation blocked; breach prohibited.");
        _declare(AutonomyRule.IndependenceRequired, "Independence required; dependency prohibited.");
        _declare(AutonomyRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(AutonomyRule.TransparencyInAutonomySystems, "Autonomy systems must be transparent.");
    }

    function _declare(AutonomyRule ruleType, string memory description) internal {
        frameworkCount++;
