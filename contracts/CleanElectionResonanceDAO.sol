// CleanElectionResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract CleanElectionResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Integrity Screening Program"
        string resonance;  // e.g. "Align elections with fairness and integrity"
        bool active;
    }
