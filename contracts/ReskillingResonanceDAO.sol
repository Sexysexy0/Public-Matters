// ReskillingResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract ReskillingResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "AI Reskilling Program"
        string resonance;  // e.g. "Align workforce with new AI-driven opportunities"
        bool active;
    }
