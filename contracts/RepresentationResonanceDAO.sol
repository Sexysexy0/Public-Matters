// RepresentationResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract RepresentationResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Voter Rights Program"
        string resonance;  // e.g. "Align governance with people’s voice and dignity"
        bool active;
    }
