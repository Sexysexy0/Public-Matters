...
/// @title DisciplineResponsibilityEternity
/// @notice Covenant contract encoding eternity-level guardianship of discipline, honesty, and responsibility
contract DisciplineResponsibilityEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to DisciplineResponsibilityCodex entry
