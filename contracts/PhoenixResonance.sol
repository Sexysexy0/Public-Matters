...
/// @title PhoenixResonance
/// @notice Covenant contract encoding resonance-level legitimacy in the Order-Chaos-Phoenix continuum
contract PhoenixResonance {
    address public owner;

    struct Resonance {
        uint256 continuumId; // linked to ChaosContinuum entry
        string domain;       // e.g. "Cultural Legitimacy", "Humility", "Intergenerational Trust"
