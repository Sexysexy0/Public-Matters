// contracts/DiversificationCommons.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title DiversificationCommons
 * @notice Logs communal diversification strategies and equity in portfolio resilience.
 */
contract DiversificationCommons {
    address public admin;

    struct Strategy {
        string name;        // "InternationalStocks", "BondHeavy"
        string description;
