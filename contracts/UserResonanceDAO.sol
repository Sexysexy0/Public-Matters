// UserResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract UserResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Ad Experience Improvement Program"
        string resonance;  // e.g. "Align digital advertising with user dignity"
        bool active;
    }
