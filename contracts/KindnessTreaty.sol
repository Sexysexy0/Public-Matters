...
/// @title Kindness Treaty
/// @notice Unifies kindness commitments into treaty law.
/// @dev Complements UnityCharter, CompassionFramework, and CommunalHarmonyTreaty.

contract KindnessTreaty {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(KindnessRule.EmpathyAnchored, "Empathy is anchored; suppression prohibited.");
        _declare(KindnessRule.GenerosityProtected, "Generosity is protected; blocking prohibited.");
        _declare(KindnessRule.HumaneTreatmentSafeguarded, "Humane treatment safeguarded; erasure prohibited.");
        _declare(KindnessRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(KindnessRule.MandatoryCouncilOversight, "Council oversight required for kindness enforcement.");
        _declare(KindnessRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }
