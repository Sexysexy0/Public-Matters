...
/// @title Nurture Treaty
/// @notice Unifies nurture commitments into treaty law.
/// @dev Complements CareTreaty, EmpathyMandala, and CompassionFramework.

contract NurtureTreaty {
    ...
    enum NurtureRule {
        NurtureIsConstitutional,
        GrowthAnchored,
        NeglectProhibited,
        AbandonmentBlocked,
        IndifferenceSuppressed,
        PublicBenefitPriority,
        TransparencyInNurtureSystems
    }
    ...
    event RuleDeclared(uint256 indexed id, NurtureRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(NurtureRule.NurtureIsConstitutional, "Nurture is constitutional; denial prohibited.");
        _declare(NurtureRule.GrowthAnchored, "Growth anchored; failure prohibited.");
        _declare(NurtureRule.NeglectProhibited, "Neglect prohibited; violation blocked.");
        _declare(NurtureRule.AbandonmentBlocked, "Abandonment blocked; breach prohibited.");
        _declare(NurtureRule.IndifferenceSuppressed, "Indifference suppressed; abdication prohibited.");
        _declare(NurtureRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(NurtureRule.TransparencyInNurtureSystems, "Nurture systems must be transparent.");
    }

    function _declare(NurtureRule ruleType, string memory description) internal {
        treatyCount++;
