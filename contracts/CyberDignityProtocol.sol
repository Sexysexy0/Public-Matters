// contracts/CyberDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title CyberDignityProtocol
 * @notice Ensures validator-grade dignity in cyber defense and communal audit.
 */
contract CyberDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "Transparency", "Accountability", "NoExploit"
        string description;
