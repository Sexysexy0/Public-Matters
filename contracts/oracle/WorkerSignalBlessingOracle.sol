// SPDX-License-Identifier: WorkerSignalBlessing-License
pragma solidity ^0.8.0;

contract WorkerSignalBlessingOracle {
    ...
    event BlessingSignalEmitted(string workerID, string region, bool blessingConfirmed, string clauseType, uint timestamp);
    ...
    function emitBlessing(string memory workerID, string memory region, bool blessingConfirmed, string memory clauseType) public {
        ...
        emit BlessingSignalEmitted(workerID, region, blessingConfirmed, clauseType, block.timestamp);
    }
