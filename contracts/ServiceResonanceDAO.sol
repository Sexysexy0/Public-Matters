// ServiceResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract ServiceResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Community Outreach Program"
        string resonance;  // e.g. "Prioritize citizen welfare over politics"
        bool active;
    }
