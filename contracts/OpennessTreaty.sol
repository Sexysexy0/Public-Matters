...
/// @title Openness Treaty
/// @notice Unifies openness commitments into treaty law.
/// @dev Complements DutyMandala, TransparencyMandala, and VisibilityFramework.

contract OpennessTreaty {
    ...
    enum OpennessRule {
        OpennessIsConstitutional,
        TransparencyAnchored,
        SecrecyProhibited,
        ConcealmentBlocked,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        OpennessInSystemsRequired
    }
    ...
    event RuleDeclared(uint256 indexed id, OpennessRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(OpennessRule.OpennessIsConstitutional, "Openness is constitutional; denial prohibited.");
        _declare(OpennessRule.TransparencyAnchored, "Transparency anchored; failure prohibited.");
        _declare(OpennessRule.SecrecyProhibited, "Secrecy prohibited; violation blocked.");
        _declare(OpennessRule.ConcealmentBlocked, "Concealment blocked; breach prohibited.");
        _declare(OpennessRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(OpennessRule.MandatoryCouncilOversight, "Council oversight required for openness enforcement.");
        _declare(OpennessRule.OpennessInSystemsRequired, "Openness required in all systems.");
    }

    function _declare(OpennessRule ruleType, string memory description) internal {
        treatyCount++;
