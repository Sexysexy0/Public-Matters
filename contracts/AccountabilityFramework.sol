...
/// @notice Encodes systemic responsibility safeguards.
/// @dev Complements TransparencyTreaty, RaceFirewall, and CitizensDividendMandala.

contract AccountabilityFramework {
    ...
    enum AccountabilityRule {
        ...
        AbuseOfPowerProhibited,
        BreachOfTrustBlocked,
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(AccountabilityRule.AbuseOfPowerProhibited, "Abuse of power prohibited; breach blocked.");
        _declare(AccountabilityRule.BreachOfTrustBlocked, "Breach of trust blocked; integrity safeguarded.");
        _declare(AccountabilityRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(AccountabilityRule.MandatoryCouncilOversight, "Council oversight required for accountability enforcement.");
