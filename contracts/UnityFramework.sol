...
/// @notice Encodes unity as systemic safeguard.
/// @dev Complements DignityMandala, CompassionTreaty, and JusticeCodex.

contract UnityFramework {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(UnityRule.SolidarityAnchored, "Solidarity anchored; suppression prohibited.");
        _declare(UnityRule.CooperationProtected, "Cooperation protected; blocking prohibited.");
        _declare(UnityRule.HarmonySafeguarded, "Harmony safeguarded; erosion prohibited.");
