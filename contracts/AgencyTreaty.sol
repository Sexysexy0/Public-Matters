...
/// @title Agency Treaty
/// @notice Unifies agency commitments into treaty law.
/// @dev Complements AutonomyFramework, RespectMandala, and ResponsibilityMandala.

contract AgencyTreaty {
    ...
    enum AgencyRule {
        AgencyIsConstitutional,
        SelfDirectionAnchored,
        AbdicationProhibited,
        PawnhoodBlocked,
        ManipulationSuppressed,
        PublicBenefitPriority,
        TransparencyInAgencySystems
    }

    enum ViolationType {
        AgencyDenial,
        SelfDirectionFailure,
        Abdication,
        Pawnhood,
        Manipulation,
        CouncilBypass,
    ...
    event RuleDeclared(uint256 indexed id, AgencyRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(AgencyRule.AgencyIsConstitutional, "Agency is constitutional; denial prohibited.");
        _declare(AgencyRule.SelfDirectionAnchored, "Self-direction anchored; abdication prohibited.");
        _declare(AgencyRule.AbdicationProhibited, "Abdication prohibited; violation blocked.");
        _declare(AgencyRule.PawnhoodBlocked, "Pawnhood blocked; autonomy required.");
        _declare(AgencyRule.ManipulationSuppressed, "Manipulation suppressed; breach prohibited.");
        _declare(AgencyRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(AgencyRule.TransparencyInAgencySystems, "Agency systems must be transparent.");
    }

    function _declare(AgencyRule ruleType, string memory description) internal {
        treatyCount++;
