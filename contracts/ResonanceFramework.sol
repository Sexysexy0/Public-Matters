...
contract ResonanceFramework {
    ...
    event RuleDeclared(uint256 indexed id, ResonanceRule ruleType);
    ...
    function _declare(ResonanceRule ruleType, string memory description) internal {
        frameworkCount++;
