...
/// @title Responsibility Treaty
/// @notice Unifies responsibility commitments into treaty law.
/// @dev Complements TransparencyMandala, AccountabilityTreaty, and DialogueCharter.

contract ResponsibilityTreaty {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(ResponsibilityRule.CEOFixAssertionMandatory, "CEO must assert fixes for identified issues.");
