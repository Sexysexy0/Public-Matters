...
/// @notice Encodes shared struggle, resilience, and positivity in governance.
/// @dev Complements CollectiveCatharsisCharter and NationalSecurityCovenant.

contract ResilienceCharter {
    ...
    enum ResilienceRule {
        SharedStruggleAcknowledged,
        ResilienceProtected,
        PositivityConstitutionalized,
    ...
    function _declareDefaultRules() internal {
        _declare(ResilienceRule.SharedStruggleAcknowledged, "All citizens share struggle; denial prohibited.");
        _declare(ResilienceRule.ResilienceProtected, "Resilience is protected; bottom rock joy is valid.");
        _declare(ResilienceRule.PositivityConstitutionalized, "Positivity is constitutional; humor and optimism safeguarded.");
