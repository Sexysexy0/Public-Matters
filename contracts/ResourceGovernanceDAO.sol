// ResourceGovernanceDAO.sol
pragma solidity ^0.8.0;

contract ResourceGovernanceDAO {
    struct Proposal {
        uint256 id;
        string topic;       // e.g. "Implement community-driven oversight of resource allocation and sustainability policies"
        uint256 votesFor;
