...
contract StabilityResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Western Hemisphere Cooperation Program"
        string resonance;  // e.g. "Align governance with peace and cooperation"
        bool active;
    }
