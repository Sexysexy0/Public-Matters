// AutonomyResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract AutonomyResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Digital Rights Program"
        string resonance;  // e.g. "Align governance with autonomy and privacy"
        bool active;
    }
