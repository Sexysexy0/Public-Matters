// contracts/CopyrightShield.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title CopyrightShield
 * @notice Ensures communal dignity and copyright protection in digital platforms.
 */
contract CopyrightShield {
    address public admin;

    struct Action {
        string actor;       // "Spotify", "Government", "PirateGroup"
        string measure;     // "LegalCase", "SecurityUpgrade"
