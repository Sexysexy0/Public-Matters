// contracts/FinanceDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title FinanceDignityProtocol
 * @notice Ensures validator-grade dignity in financial systems.
 */
contract FinanceDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "Transparency", "Equity", "NoPredatoryLoans"
        string description;
