// contracts/TradeDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title TradeDignityProtocol
 * @notice Ensures validator-grade dignity in global trade systems.
 */
contract TradeDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "FairAccess", "NoBlockade"
        string description;
