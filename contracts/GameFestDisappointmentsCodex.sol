...
/// @title GameFestDisappointmentsCodex
/// @notice Covenant contract encoding safeguards for release equity and hype integrity
contract GameFestDisappointmentsCodex {
    address public owner;

    struct Safeguard {
        uint256 arcId;     // linked to disappointment arc
        string domain;     // e.g. "Delays", "Exclusivity", "Hype Integrity", "Pricing", "Surprise Factor"
    ...
    /// @notice Encode disappointment arc into covenant safeguard
