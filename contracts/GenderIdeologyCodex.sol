...
/// @title GenderIdeologyCodex
/// @notice Covenant contract encoding safeguards for children, free speech, and institutional guardianship
contract GenderIdeologyCodex {
    address public owner;

    struct Safeguard {
        uint256 arcId;     // linked to cultural arc
        string domain;     // e.g. "Child Safeguards", "Free Speech", "Mob Psychology", "Institutional Responsibility"
