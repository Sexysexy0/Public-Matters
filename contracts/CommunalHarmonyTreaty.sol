...
/// @title Communal Harmony Treaty
/// @notice Unifies harmony commitments into treaty law.
/// @dev Complements JusticeEquilibrium, HumanSolidarityTreaty, and EquityMandala.

contract CommunalHarmonyTreaty {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(HarmonyRule.PeaceAnchored, "Peace is anchored; suppression prohibited.");
        _declare(HarmonyRule.CooperationProtected, "Cooperation is protected; blocking prohibited.");
        _declare(HarmonyRule.CulturalResonanceSafeguarded, "Cultural resonance safeguarded; erasure prohibited.");
        _declare(HarmonyRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(HarmonyRule.MandatoryCouncilOversight, "Council oversight required for harmony enforcement.");
        _declare(HarmonyRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }
