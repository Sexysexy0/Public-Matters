...
/// @title Spanda Framework
/// @notice Encodes pulsation as origin of cycles.
/// @dev Complements MahakalaCovenant, TranscendenceTreaty, and ResonanceFramework.

contract SpandaFramework {
    ...
    enum SpandaRule {
        PulsationIsConstitutional,
        OriginAnchored,
        CycleIntegrityProtected,
        CreationRippleSafeguarded,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        TransparencyInSpandaSystems
    }
    ...
    event RuleDeclared(uint256 indexed id, SpandaRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(SpandaRule.PulsationIsConstitutional, "Pulsation is constitutional; denial prohibited.");
        _declare(SpandaRule.OriginAnchored, "Origin anchored; suppression prohibited.");
        _declare(SpandaRule.CycleIntegrityProtected, "Cycle integrity protected; distortion prohibited.");
        _declare(SpandaRule.CreationRippleSafeguarded, "Creation ripple safeguarded; blocking prohibited.");
        _declare(SpandaRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(SpandaRule.MandatoryCouncilOversight, "Council oversight required for pulsation enforcement.");
        _declare(SpandaRule.TransparencyInSpandaSystems, "Spanda systems must be transparent.");
    }

    function _declare(SpandaRule ruleType, string memory description) internal {
        frameworkCount++;
