...
/// @title MITEternity
/// @notice Covenant contract to encode eternity-level guardianship of MIT program integrity
contract MITEternity {
    address public owner;

    struct Eternity {
        uint256 providenceId; // linked to MITProvidence entry
        string domain;        // e.g. "Academic Integrity", "Faculty Empowerment", "Institutional Excellence"
