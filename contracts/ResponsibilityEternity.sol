...
/// @title ResponsibilityEternity
/// @notice Covenant contract encoding eternity-level guardianship of discipline, responsibility, and resilience
contract ResponsibilityEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to ResponsibilityCodex entry
