...
/// @title Moral Standing Framework
/// @notice Encodes moral standing safeguards.
/// @dev Complements CooperationTreaty, HonorMandala, and IntegrityCharter.

contract MoralStandingFramework {
    ...
    enum MoralRule {
        MoralStandingIsConstitutional,
        EthicsAnchored,
        ValuesProtected,
        CorruptionSuppressed,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        TransparencyInMoralSystems
    }
    ...
    event RuleDeclared(uint256 indexed id, MoralRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(MoralRule.MoralStandingIsConstitutional, "Moral standing is constitutional; denial prohibited.");
        _declare(MoralRule.EthicsAnchored, "Ethics anchored; failure prohibited.");
        _declare(MoralRule.ValuesProtected, "Values protected; erosion prohibited.");
        _declare(MoralRule.CorruptionSuppressed, "Corruption suppressed; violation blocked.");
        _declare(MoralRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(MoralRule.MandatoryCouncilOversight, "Council oversight required for moral enforcement.");
        _declare(MoralRule.TransparencyInMoralSystems, "Moral systems must be transparent.");
    }

    function _declare(MoralRule ruleType, string memory description) internal {
        frameworkCount++;
