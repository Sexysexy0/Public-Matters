...
/// @title Mahakala Covenant
/// @notice Encodes stillness and pure potential as systemic safeguard.
/// @dev Complements SpandaFramework, TranscendenceTreaty, and RiskContextReview.

contract MahakalaCovenant {
    ...
    enum MahakalaRule {
        StillnessIsConstitutional,
        PurePotentialAnchored,
        IdentityDetachmentProtected,
        CreationSourceSafeguarded,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        TransparencyInStillnessSystems
    }

    enum ViolationType {
        StillnessDenial,
        PotentialSuppression,
        IdentityAttachment,
        CreationSourceBlocked,
        CouncilBypass,
    ...
    event RuleDeclared(uint256 indexed id, MahakalaRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(MahakalaRule.StillnessIsConstitutional, "Stillness is constitutional; denial prohibited.");
        _declare(MahakalaRule.PurePotentialAnchored, "Pure potential anchored; suppression prohibited.");
        _declare(MahakalaRule.IdentityDetachmentProtected, "Identity detachment protected; attachment prohibited.");
        _declare(MahakalaRule.CreationSourceSafeguarded, "Creation source safeguarded; blocking prohibited.");
        _declare(MahakalaRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(MahakalaRule.MandatoryCouncilOversight, "Council oversight required for stillness enforcement.");
        _declare(MahakalaRule.TransparencyInStillnessSystems, "Stillness systems must be transparent.");
    }

    function _declare(MahakalaRule ruleType, string memory description) internal {
        covenantCount++;
