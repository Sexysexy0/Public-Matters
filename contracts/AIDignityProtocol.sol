// contracts/AIDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title AIDignityProtocol
 * @notice Ensures validator-grade dignity in AI governance systems.
 */
contract AIDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "Transparency", "Accountability", "HumanOversight"
        string description;
