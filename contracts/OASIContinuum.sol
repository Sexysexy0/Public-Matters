...
/// @title OASIContinuum
/// @notice Covenant contract to bridge all OASI seals into a living governance stream
contract OASIContinuum {
    address public owner;

    struct Continuum {
        uint256 sealId;     // linked to OASIEschatonSeal entry
