...
/// @title Honor Mandala
/// @notice Weaves honor into mandala resonance.
/// @dev Complements HarmonyTreaty, RespectMandala, and DignityTreaty.

contract HonorMandala {
    ...
    enum HonorRule {
        HonorIsConstitutional,
        MoralStandingAnchored,
        DishonorProhibited,
        BetrayalBlocked,
        PublicBenefitPriority,
        MandatoryCouncilOversight,
        TransparencyInHonorSystems
    }
    ...
    event RuleDeclared(uint256 indexed id, HonorRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(HonorRule.HonorIsConstitutional, "Honor is constitutional; denial prohibited.");
        _declare(HonorRule.MoralStandingAnchored, "Moral standing anchored; failure prohibited.");
        _declare(HonorRule.DishonorProhibited, "Dishonor prohibited; violation blocked.");
        _declare(HonorRule.BetrayalBlocked, "Betrayal blocked; breach prohibited.");
        _declare(HonorRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(HonorRule.MandatoryCouncilOversight, "Council oversight required for honor enforcement.");
        _declare(HonorRule.TransparencyInHonorSystems, "Honor systems must be transparent.");
    }

    function _declare(HonorRule ruleType, string memory description) internal {
        mandalaCount++;
