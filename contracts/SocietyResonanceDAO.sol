// SocietyResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract SocietyResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Public Good Program"
        string resonance;  // e.g. "Align governance with social responsibility and sustainability"
        bool active;
    }
