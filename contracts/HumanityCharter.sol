...
/// @title Humanity Charter
/// @notice Firewall for humanity and collective dignity.
/// @dev Complements ResonanceFramework, MercyTreaty, and CompassionMandala.

contract HumanityCharter {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(HumanityRule.DignityAnchored, "Dignity is anchored; suppression prohibited.");
        _declare(HumanityRule.HumaneTreatmentProtected, "Humane treatment is protected; blocking prohibited.");
        _declare(HumanityRule.EqualitySafeguarded, "Equality safeguarded; erasure prohibited.");
        _declare(HumanityRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(HumanityRule.MandatoryCouncilOversight, "Council oversight required for humanity enforcement.");
        _declare(HumanityRule.TransparencyInHumanitySystems, "Humanity systems must be transparent.");
    }
