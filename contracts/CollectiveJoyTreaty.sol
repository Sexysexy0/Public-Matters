...
/// @title Collective Joy Treaty
/// @notice Unifies joy and resilience into treaty law.
/// @dev Complements HopeFramework and ResilienceCharter.

contract CollectiveJoyTreaty {
    ...
    enum JoyRule {
        ...
        ResilienceIsBinding,
        OptimismIsProtected,
        CollectiveCatharsisAcknowledged,
    ...
    event RuleDeclared(uint256 indexed id, JoyRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(JoyRule.JoyIsConstitutional, "Joy is constitutional; denial prohibited.");
        _declare(JoyRule.ResilienceIsBinding, "Resilience is binding across treaty members.");
        _declare(JoyRule.OptimismIsProtected, "Optimism is protected; positivity safeguarded.");
        _declare(JoyRule.CollectiveCatharsisAcknowledged, "Collective catharsis acknowledged; humor and relief valid.");
        _declare(JoyRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(JoyRule.MandatoryCouncilOversight, "Council oversight required for joy enforcement.");
        _declare(JoyRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }

    function _declare(JoyRule ruleType, string memory description) internal {
        treatyCount++;
