// contracts/PlanetaryDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title PlanetaryDignityProtocol
 * @notice Ensures validator-grade dignity in climate justice and energy systems.
 */
contract PlanetaryDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "CarbonEquity", "RenewablePriority"
        string description;
