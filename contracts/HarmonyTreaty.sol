...
/// @title Harmony Treaty
/// @notice Unifies harmony commitments into treaty law.
/// @dev Complements RespectMandala, JusticeMandala, and EquityFramework.
...
contract HarmonyTreaty {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(HarmonyRule.CooperationAnchored, "Cooperation anchored; failure prohibited.");
        _declare(HarmonyRule.DiscordProhibited, "Discord prohibited; violation blocked.");
        _declare(HarmonyRule.BalanceSafeguarded, "Balance safeguarded; collapse prohibited.");
        ...
        _declare(HarmonyRule.TransparencyInHarmonySystems, "Harmony systems must be transparent.");
    }
