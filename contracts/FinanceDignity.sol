// contracts/FinanceDignity.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title FinanceDignity
 * @notice Ensures validator-grade dignity in portfolio construction and communal equity.
 */
contract FinanceDignity {
    address public admin;

    struct Rule {
        string name;        // "Transparency", "RiskEquity"
        string description;
