...
contract FairnessMandala {
    ...
    event RuleDeclared(uint256 indexed id, FairnessRule ruleType);
    ...
    function _declare(FairnessRule ruleType, string memory description) internal {
        mandalaCount++;
