// ClimateGovernanceDAO.sol
pragma solidity ^0.8.0;

contract ClimateGovernanceDAO {
    struct Proposal {
        uint256 id;
        string topic;       // e.g. "Implement community-driven oversight of climate policies and sustainability programs"
        uint256 votesFor;
