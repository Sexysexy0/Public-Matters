...
/// @title Growth Mandala
/// @notice Weaves growth into mandala resonance.
/// @dev Complements KindnessFramework, NurtureTreaty, and VisionCharter.

contract GrowthMandala {
    ...
    enum GrowthRule {
        GrowthIsConstitutional,
        DevelopmentAnchored,
        StagnationProhibited,
        DeclineBlocked,
        RegressionSuppressed,
        PublicBenefitPriority,
        TransparencyInGrowthSystems
    }
    ...
    event RuleDeclared(uint256 indexed id, GrowthRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(GrowthRule.GrowthIsConstitutional, "Growth is constitutional; denial prohibited.");
        _declare(GrowthRule.DevelopmentAnchored, "Development anchored; failure prohibited.");
        _declare(GrowthRule.StagnationProhibited, "Stagnation prohibited; violation blocked.");
        _declare(GrowthRule.DeclineBlocked, "Decline blocked; breach prohibited.");
        _declare(GrowthRule.RegressionSuppressed, "Regression suppressed; backward movement prohibited.");
        _declare(GrowthRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(GrowthRule.TransparencyInGrowthSystems, "Growth systems must be transparent.");
    }

    function _declare(GrowthRule ruleType, string memory description) internal {
        mandalaCount++;
