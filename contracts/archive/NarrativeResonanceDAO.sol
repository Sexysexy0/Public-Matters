// NarrativeResonanceDAO.sol
pragma solidity ^0.8.0;

contract NarrativeResonanceDAO {
    struct Initiative {
        uint256 id;
        string program;    // e.g. "Civic Empowerment Media Program"
        string resonance;  // e.g. "Align media narratives with public empowerment"
        bool active;
    }
