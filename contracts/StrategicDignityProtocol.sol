// contracts/StrategicDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title StrategicDignityProtocol
 * @notice Ensures validator-grade dignity in geopolitical agreements.
 */
contract StrategicDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "LeaseSecurity", "SovereigntyRespect"
        string description;
