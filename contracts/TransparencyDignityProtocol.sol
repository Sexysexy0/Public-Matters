// contracts/TransparencyDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title TransparencyDignityProtocol
 * @notice Ensures validator-grade dignity in transparency systems.
 */
contract TransparencyDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "FullDisclosure", "CommunityAudit", "NoHiddenFunds"
        string description;
