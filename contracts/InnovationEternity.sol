...
/// @title InnovationEternity
/// @notice Covenant contract encoding eternity-level guardianship of innovation values
contract InnovationEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to InnovationCodex entry
        string domain;     // e.g. "Agility", "Analytics", "Leadership Divergence", "IT Scaffolding"
