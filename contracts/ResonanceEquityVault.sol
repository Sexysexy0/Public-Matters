...
contract ResonanceEquityVault is Ownable {
    ...
    event ResonanceLogged(address indexed steward, string arc, string safeguard);
    ...
    function logResonance(string memory _arc, string memory _safeguard) public {
        resonances.push(Resonance(msg.sender, _arc, _safeguard, block.timestamp, false));
