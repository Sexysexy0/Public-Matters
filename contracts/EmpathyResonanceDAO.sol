// EmpathyResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract EmpathyResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Customer Care Empowerment Program"
        string resonance;  // e.g. "Align service delivery with empathy and dignity"
        bool active;
    }
