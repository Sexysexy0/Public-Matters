// PlanetaryStewardshipGovernanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract PlanetaryStewardshipGovernanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Proposal {
        uint256 id;
        string topic;       // e.g. "Expand biodiversity protection and enforce ecological preservation standards"
        uint256 votesFor;
