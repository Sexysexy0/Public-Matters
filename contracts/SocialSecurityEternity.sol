...
/// @title SocialSecurityEternity
/// @notice Covenant contract to encode eternity-level guardianship of Social Security & Medicare
contract SocialSecurityEternity {
    address public owner;

    struct Eternity {
        uint256 providenceId; // linked to SocialSecurityProvidence entry
        string domain;        // e.g. "Social Security", "Medicare", "Intergenerational Guardianship"
