// contracts/KnowledgeDignityProtocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;

/**
 * @title KnowledgeDignityProtocol
 * @notice Ensures communal dignity in education systems.
 */
contract KnowledgeDignityProtocol {
    address public admin;

    struct Rule {
        string name;        // "NoExclusion", "Transparency", "Equity"
        string description;
