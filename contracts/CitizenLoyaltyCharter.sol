...
/// @title Citizen Loyalty Charter
/// @notice Encodes citizen loyalty obligations and protections.
/// @dev Complements NationalSecurityCovenant and DefenseTransparency.

contract CitizenLoyaltyCharter {
    ...
    enum LoyaltyRule {
        DutyToDefendNation,
        DutyToReportTreason,
        DutyToRespectConstitution,
        RightToProtection,
        RightToTransparency,
        MandatoryCouncilOversight,
        LoyaltyIntegrityIsConstitutional
    }
    ...
    event RuleDeclared(uint256 indexed id, LoyaltyRule ruleType);
    ...
    function _declareDefaultRules() internal {
        _declare(LoyaltyRule.DutyToDefendNation, "Citizens must defend the nation in times of war.");
        _declare(LoyaltyRule.DutyToReportTreason, "Citizens must report treasonous acts.");
        _declare(LoyaltyRule.DutyToRespectConstitution, "Citizens must respect the Constitution.");
        _declare(LoyaltyRule.RightToProtection, "Citizens have the right to protection by the state.");
        _declare(LoyaltyRule.RightToTransparency, "Citizens have the right to transparent governance.");
        _declare(LoyaltyRule.MandatoryCouncilOversight, "Council oversight required for loyalty enforcement.");
        _declare(LoyaltyRule.LoyaltyIntegrityIsConstitutional, "Loyalty integrity is constitutional.");
    }

    function _declare(LoyaltyRule ruleType, string memory description) internal {
        charterCount++;
