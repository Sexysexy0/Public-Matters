...
/// @title Leadership Charter
/// @notice Firewall for leadership dignity and fairness.
/// @dev Complements DelegationFramework, GovernanceCharter, and FeedbackOracle.

contract LeadershipCharter {
    ...
    enum LeadershipRule {
        LeadershipIsConstitutional,
        IntegrityAnchored,
        VisionProtected,
        HumaneAuthoritySafeguarded,
    ...
    function _declareDefaultRules() internal {
        _declare(LeadershipRule.LeadershipIsConstitutional, "Leadership is constitutional; denial prohibited.");
        _declare(LeadershipRule.IntegrityAnchored, "Integrity is anchored; suppression prohibited.");
        _declare(LeadershipRule.VisionProtected, "Vision is protected; blocking prohibited.");
        _declare(LeadershipRule.HumaneAuthoritySafeguarded, "Humane authority safeguarded; abuse prohibited.");
        _declare(LeadershipRule.PublicBenefitPriority, "Public benefit overrides elite gain.");
        _declare(LeadershipRule.MandatoryCouncilOversight, "Council oversight required for leadership enforcement.");
        _declare(LeadershipRule.TransparencyInLeadershipSystems, "Leadership systems must be transparent.");
    }
