...
contract LearningResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Curriculum Innovation Program"
        string resonance;  // e.g. "Align education with social and economic needs"
        bool active;
    }
