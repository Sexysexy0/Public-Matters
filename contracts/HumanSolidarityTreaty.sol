...
/// @title Human Solidarity Treaty
/// @notice Unifies solidarity commitments into treaty law.
/// @dev Complements EquityMandala, GlobalWellbeingTreaty, and DignityCharter.

contract HumanSolidarityTreaty {
    ...
    function _declareDefaultRules() internal {
        ...
        _declare(SolidarityRule.TreatyBindingAcrossMembers, "Treaty rules binding across all members.");
    }
