...
/// @title FocusEternity
/// @notice Covenant contract encoding eternity-level guardianship of focus and attention span safeguards
contract FocusEternity {
    address public owner;

    struct Eternity {
        uint256 codexId;   // linked to FocusCodex entry
