// ConservationResonanceDAO.sol
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/access/Ownable.sol";

contract ConservationResonanceDAO is Ownable {

    constructor() Ownable(msg.sender) {}

    struct Initiative {
        uint256 id;
        string program;    // e.g. "Water Conservation Program"
        string resonance;  // e.g. "Align water use with sustainability and equity"
        bool active;
    }
