...
contract ResonanceCodexYouthEmploymentII {
    ...
    struct CodexEntry {
        string theme;       // job equity, hiring audit, worker trust
        string narrative;   // how youth employment reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
