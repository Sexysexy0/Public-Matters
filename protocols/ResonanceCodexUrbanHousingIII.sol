...
contract ResonanceCodexUrbanHousingIII {
    ...
    struct CodexEntry {
        string theme;       // shelter equity, housing audit, community trust
        string narrative;   // how housing resilience anchors communal trust during systemic debt resets
        uint256 timestamp;
    }
