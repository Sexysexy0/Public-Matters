...
contract ResonanceCodexTeacherDignityIII {
    ...
    struct CodexEntry {
        string theme;       // education equity, classroom audit, teaching trust
        string narrative;   // how teacher dignity reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
